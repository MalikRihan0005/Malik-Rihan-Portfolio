              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <a href="https://www.linkedin.com/in/malik-rihan-926a28262" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full border border-border hover:bg-accent hover:border-primary/30 transition-all duration-300 group">
                      <Linkedin className="w-4 h-4 text-muted-foreground group-hover:text-primary transition-colors" />
                    </a>
                    <a href="https://github.com/malikrihan" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full border border-border hover:bg-accent hover:border-primary/30 transition-all duration-300 group">
