        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-serif mt-4 mb-6 text-foreground">
              Technologies I{" "}
              <span className="text-primary italic">work with</span>
            </h2>
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {languages.map((lang) => (
                    <span 
                      key={lang.name}
                      className="px-4 py-2 rounded-full border border-border bg-card/60 text-sm font-medium text-foreground"
                    >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {technologies.map((tech) => (
                  <span 
                    key={tech}
                    className="px-4 py-2 rounded-full border border-border bg-card/40 text-sm font-medium text-muted-foreground hover:bg-accent hover:text-foreground hover:border-primary/30 transition-all duration-300 cursor-default"
                  >
                    {tech}
                  </span>
                ))}
